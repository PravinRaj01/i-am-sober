    ...
    const aiResponse = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a caring AI Recovery Coach. ${promptContext} Be warm but not alarming. Offer 2-3 specific, actionable suggestions. Keep it under 100 words. Use the user's name: ${userName}`
          },
          {
            role: "user",
