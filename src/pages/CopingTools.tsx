...
import { ArrowLeft, Heart, Wind, Footprints, Phone, Music, Book, Play, StopCircle, ChevronLeft, ChevronRight } from "lucide-react";
              ...
              <div className="space-y-6">
                <div className="relative aspect-square max-w-md mx-auto bg-gradient-to-br from-primary/10 to-accent/10 rounded-3xl p-12 backdrop-blur-sm">
                  ...
                  <div className="absolute inset-12 border-4 rounded-2xl transition-colors duration-300"
                    ...
                    {/* Animated indicator */}
                    <div 
                      className="absolute w-6 h-6 rounded-full shadow-2xl transition-all duration-75 ease-linear"
                      style={{
