...
import { Plus, RefreshCw, TrendingUp, Clock, User, Info, ArrowLeft } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div className="flex-1 min-w-0">
              <h1 className="text-2xl font-bold truncate">Community</h1>
            ...
            {!interactions || interactions.length === 0 ? (
              ...
              interactions.map((interaction: any) => (
                <MilestoneCard
                  ...
                  userLevel={interaction.profiles?.level}
                  userXp={interaction.profiles?.xp}
