...
import { ArrowLeft, BookOpen, Loader2, Plus, Pencil, Trash2, Search, Sparkles, Edit2 } from "lucide-react";
            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-center">
                ...
                <Button 
                  ...
                  className="group"
                >
                  <BookOpen className="h-5 w-5 mr-2 text-primary group-hover:text-primary/70" />
                  View Sample Entry
                </Button>
              </div>
            </div>
